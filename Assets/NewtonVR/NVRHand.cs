        ...
        public void Initialize()
        {
            ...
            if (Player.PhysicalHands == true)
            {
                ...
                if (Player.AutomaticallySetControllerTransparency == true)
                {
                    ...
                    {
						if (GhostRenderers [rendererIndex].name != "Base" &&
							GhostRenderers [rendererIndex].tag != "Brick" &&
							GhostRenderers [rendererIndex].tag != "BrickPanels"&&
							GhostRenderers [rendererIndex].tag != "BrickPrototype") {
